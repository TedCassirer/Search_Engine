...
public class BSBIIndexer{
    ...
    public int indexCount = 2;//documentCount/documentsPerBlock + 1;
    ...
    public void indexBlock(File[] block){
        ...
        insertIntoIndex(qList, offset);
    }

    /**
     *  Writes to the correct hashedIndex by reading and writing them to the disk.
     */
    public void insertIntoIndex(ArrayList<LinkedList<Quad>> qList, int offset) {
        Iterator<Quad> qt;
        ...
        for(int i = 0; i < indexCount; i++){
            ...
            while(qt.hasNext()) {
                ...
                hashedIndex.docLengths.put("" + q.docID, offset);
            }
