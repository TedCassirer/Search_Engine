	...
	private void createGUI() {
		...
		Action loadIndex = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					in2 = new ObjectInputStream(new FileInputStream("savedIndex/mainIndex.ser"));
					indexer.index = (Index) in2.readObject();
				} catch (IOException es) {
					// report
				} catch (ClassNotFoundException fi) {
					// report
